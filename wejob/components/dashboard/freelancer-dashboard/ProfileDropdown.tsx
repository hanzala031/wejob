...
const ProfileDropdown: React.FC = () => {
  ...
  const userName = profile?.full_name || (profile ? `${profile.first_name || ''} ${profile.last_name || ''}`.trim() : 'Freelancer');
  const userAvatar = profile?.avatar_url || 'https://res.cloudinary.com/dxvkigop9/image/upload/v1763111444/5-1714127904-1714127904-100x100_wgxdsx.jpg';
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className="hidden sm:block text-left">
          ...
          <p className="text-xs text-gray-500 mt-1">Freelancer</p>
        </div>
